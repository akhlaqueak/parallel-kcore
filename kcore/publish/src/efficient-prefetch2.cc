...
__global__ void selectNodesAtLevel72(unsigned int *degrees, unsigned int level, unsigned int V,
...
__global__ void processNodes72(G_pointers d_p, int level, int V,
                               unsigned int *bufTails, unsigned int *glBuffers,
...
int kcoreEfficientScanPrefetch2(Graph &data_graph)
{
    ...
    while (count < data_graph.V)
    {
        ...
        selectNodesAtLevel72<<<BLK_NUMS, BLK_DIM>>>(data_pointers.degrees, level,
                                                    data_graph.V, bufTails, glBuffers);

        processNodes72<<<BLK_NUMS, BLK_DIM>>>(data_pointers, level, data_graph.V,
